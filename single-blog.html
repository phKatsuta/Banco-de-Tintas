...
/* Estilos para o header para garantir que ele fique acima do conteúdo */
header.header-section {
    position: relative;
    z-index: 10; /* Garante que o header ficará acima de outros elementos */
	
}

/* Ajustes de padding para o layout */
.page-info-section {
    padding-top: 120px;  /* Aumentar o padding-top para garantir que o formulário não se sobreponha ao header */
}

.pi-content {
    padding-top: 0px;  /* Remover o padding-top extra */
}

/* Formulário de login */
.login-form {
    max-width: 400px;
    margin: 20px auto 0; /* Reduzido o margin-top para 20px */
    background-color: rgba(0, 0, 0, 0.6);
    padding: 30px;
    border-radius: 8px;
    color: white;
    z-index: 1; /* Garante que o formulário fique abaixo do header */
}
