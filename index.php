    ...
    <div class="latest-news-section">
        ...
        <div class="news-ticker">
            <div class="news-ticker-contant">
                <div class="nt-item"><span class="new">Novo</span>Alunos de ADS da FATEC Jundiaí concluem projeto de
                    banco de tintas orgânicas com sistema completo e sustentável.</div>
                <div class="nt-item"><span class="strategy">Estratégia</span>FATEC aplica estratégia inovadora para
                    criar um banco de tintas orgânicas sustentável e funcional.</div>
                <div class="nt-item"><span class="racing">Projeto</span>Scripts e automação de processos garantem a
                    funcionalidade do banco de tintas orgânicas desenvolvido por alunos de ADS </div>
            </div>
        </div>
    </div>
...
<footer class="footer-section">
    <div class="container">
        ...
        <p class="copyright">
            Copyright &copy;
            <script>document.write(new Date().getFullYear());</script> Todos os direitos reservados | Este template foi
            feito por <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com"
